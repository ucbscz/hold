...
import { ConfiguracionDto, ConfiguracionService } from '@app/entities/configuracion/api/configuracion.service';
...
export class AdminConfiguracionesComponent implements OnInit {
  ...
  guardar() {
    ...
    currentConfig.HorarioInicioMinutos = (this.horarioInicioHora * 60) + this.horarioInicioMinuto;
    currentConfig.HorarioFinMinutos = (this.horarioFinHora * 60) + this.horarioFinMinuto;
