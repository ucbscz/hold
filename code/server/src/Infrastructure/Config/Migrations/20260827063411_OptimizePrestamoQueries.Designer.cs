...
namespace IMT_Reservas.Server.src.Infrastructure.Config.Migrations
{
    ...
    [Migration("20260827063411_OptimizePrestamoQueries")]
    partial class OptimizePrestamoQueries
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IMT_Reservas.Server.Core.Entities.AuditLog", b =>
                {
                    ...
                    b.HasIndex("AdminCarnet", "Timestamp", "EstadoEliminado");

                    b.HasIndex("Entidad", "EntidadId", "EstadoEliminado");

                    b.HasIndex("Entidad", "Accion", "Timestamp", "EstadoEliminado");

                    b.ToTable("audit_logs", (string)null);
                });

            modelBuilder.Entity("IMT_Reservas.Server.Core.Entities.AvisoDisponibilidad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("CarnetUsuario")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.HasIndex("Notificado", "EstadoEliminado");

                    b.ToTable("avisos_disponibilidad", (string)null);
                });
            ...
            modelBuilder.Entity("IMT_Reservas.Server.Core.Entities.ComentarioEquipo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id_comentario_equipo");
                    ...
                    b.HasIndex("CarnetUsuario");

                    b.HasIndex("IdComentarioPadre", "EstadoEliminado");

                    b.HasIndex("IdGrupoEquipo", "FechaCreacion", "EstadoEliminado");

                    b.ToTable("comentarios_equipos", (string)null);
                });
            ...
            modelBuilder.Entity("IMT_Reservas.Server.Core.Entities.ConfiguracionSistema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("FirmaJefeCarreraBase64")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("firma_jefe_carrera_base64");

                    b.Property<int>("HorarioFinMinutos")
                        .HasColumnType("integer")
                        .HasColumnName("horario_fin_minutos");

                    b.Property<int>("HorarioInicioMinutos")
                        .HasColumnType("integer")
                        .HasColumnName("horario_inicio_minutos");

                    b.Property<int>("MinutosGraciaAtraso")
                        .HasColumnType("integer")
                        .HasColumnName("minutos_gracia_atraso");

                    b.Property<decimal>("MontoMinimoContrato")
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("monto_minimo_contrato");

                    b.Property<string>("NombreJefeCarrera")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)")
                        .HasColumnName("nombre_jefe_carrera");

                    b.Property<int>("TiempoMinimoReservaMinutos")
                        .HasColumnType("integer")
                        .HasColumnName("tiempo_minimo_reserva_minutos");

                    b.Property<int>("TiempoRecordatorioPrevioMinutos")
                        .HasColumnType("integer")
                        .HasColumnName("tiempo_recordatorio_previo_minutos");
            ...
            modelBuilder.Entity("IMT_Reservas.Server.Core.Entities.DetalleMantenimiento", b =>
                {
                    ...
                    b.HasIndex("IdEquipo", "EstadoEliminado");
            ...
            modelBuilder.Entity("IMT_Reservas.Server.Core.Entities.DetallePrestamo", b =>
                {
                    ...
                    b.HasIndex("IdGrupoEquipo", "IdEquipo", "EstadoEliminado");
            ...
            modelBuilder.Entity("IMT_Reservas.Server.Core.Entities.Equipo", b =>
                {
                    ...
                    b.HasIndex("IdGrupoEquipo", "EstadoEquipo", "EstadoEliminado");
            ...
            modelBuilder.Entity("IMT_Reservas.Server.Core.Entities.GrupoEquipo", b =>
                {
                    ...
                    b.Property<int>("TiempoMaximoPrestamoDias")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(7)
            ...
            modelBuilder.Entity("IMT_Reservas.Server.Core.Entities.Notificacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("CarnetUsuario", "Leido", "EstadoEliminado");
            ...
            modelBuilder.Entity("IMT_Reservas.Server.Core.Entities.Prestamo", b =>
                {
                    ...
                    b.Property<string>("DestinoPrestamo")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                    ...
                    b.HasIndex("EstadoEliminado", "FechaSolicitud", "Id");

                    b.HasIndex("EstadoPrestamo", "EstadoEliminado", "FechaDevolucionEsperada");

                    b.HasIndex("EstadoPrestamo", "EstadoEliminado", "FechaPrestamoEsperada");

                    b.HasIndex("EstadoPrestamo", "RecordatorioEnviado", "EstadoEliminado", "FechaDevolucionEsperada");
            ...
            modelBuilder.Entity("IMT_Reservas.Server.Core.Entities.ComentarioEquipo", b =>
                {
                    b.HasOne("IMT_Reservas.Server.Core.Entities.Usuario", "Usuario")
                        .WithMany()
                        .HasForeignKey("CarnetUsuario")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IMT_Reservas.Server.Core.Entities.ComentarioEquipo", "ComentarioPadre")
                        .WithMany()
            ...
            modelBuilder.Entity("IMT_Reservas.Server.Core.Entities.Prestamo", b =>
                {
                    ...
                    b.HasOne("IMT_Reservas.Server.Core.Entities.Carrera", "Carrera")
                        .WithMany()
                        .HasForeignKey("IdCarrera");

                    b.HasOne("IMT_Reservas.Server.Core.Entities.Contrato", "Contrato")
                        .WithMany()
